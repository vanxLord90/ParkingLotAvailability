...
parking_image_test = 'C:\\Users\\dasak\\HackAi\\ParkingLotAvailability\\parkifymodel\\1920_1080_image2.png'
...
for space in parking_spaces:
    ...
    if space_status:
        ...
        # if check_color(space_img,target_color):
        #     error_space +=1

total_spaces = open_space+closed_space
total_error = error_space/total_spaces *100.

# window_str = f"Number of Spots Available are : {open_space} / {total_spaces}  Error Percentage: {total_error}%"
